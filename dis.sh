...
mkdir dis
echo 0 | gmx trjconv -s ../pull.tpr -f ../pull.xtc -o dis/conf.gro -sep

# compute distances
for (( i=0; i<501; i++ ))
do
    gmx distance -s ../pull.tpr -f dis/conf${i}.gro -n ../index.ndx -select 'com of group "Protein" plus com of group "mol"' -oall dis/dist${i}.xvg 
done
...
for (( i=0; i<501; i++ ))
do
    d=`tail -n 1 dis/dist${i}.xvg | awk '{print $2}'`
